...
class PredictionPipelineConfig:
    ...
    preprocessor_path:str = os.path.join(artifact_folder, 'preprocessor')
...
class PredictionPipeline:
    ...
    def get_predicted_dataframe(self, input_dataframe_path: pd.DataFrame):
        ...
        try:
            ...
            input_dataframe.to_csv(self.prediction_pipeline_config.prediction_output_dirname, index= False)
